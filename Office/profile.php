                                            ...
                                            <div class="col-lg-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-footer">
                                                        <input type="submit" class="btn btn-secondary btn-sm" name="sub_btn"  value="Сохранить">
                                                    </div>
													<div class="card-body card-block">
														<div class="row form-group">
															<div class="col col-md-4"><label for="password-input" class=" form-control-label">Пароль</label></div>
															<div class="col-12 col-md-8"><input type="password" id="pass" name="r_password" placeholder="Пароль" value="<?= $row['pass'] ?>" class="form-control"><small class="help-block form-text"></small></div>
															<div class="col-md-12" style="text-align: right"><button type="button" class="btn btn-secondary" onmousedown='show()' onmouseup='hide()' ontouchstart="show()" ontouchend="hide()">Показать пароль</button></div>
														</div>														
													</div>
													<div class="card-footer">
                                                        <input type="submit" class="btn btn-secondary btn-sm" name="sub_btn2"  value="Сохранить">
                                                    </div>
													</form>
                                                </div>
                                            </div>
