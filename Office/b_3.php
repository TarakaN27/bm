        ...
        <div class="content mt-3">
            <div class="card">
                ...
                <div class="row">
					...
					if ($row['status'] <= 3) {
					?>
					<a href="#" data-bs-toggle="modal" data-bs-target="#buyTypeMarketing" class="btn btn-success"> <i class="menu-icon fa fa-sitemap " style="font-size:18px;"></i>Вход 121000 тг</a><br><br>
					...
					<span class="badge badge-success">START Level 3</span>
