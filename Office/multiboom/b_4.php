        ...
        <div class="content mt-3">
            <div class="card">
				...
				<div class="col-lg-12" style="text-align: center">
					...
					if ($row['status1'] == 9) {
					?>
					<a href="#" data-bs-toggle="modal" data-bs-target="#buyTypeMulti" class="btn btn-light"> <i class="menu-icon fa fa-sitemap " style="font-size:18px;"></i>Вход 33000000 тг</a><br><br>
