...
if (mysql_num_rows($result) != 0) {
	...
	if ($row['status'] > 0) {
		if (isset($_POST['sub_btn']) && isset($_POST['amount']) && intval($_POST['amount'])>=100 && isset($_POST['nomer']) && $_POST['nomer']!="" && $_POST['iin']!="" && $_POST['phone']!="") {
			...
			if ($row['akwa'] - $amount >= 0) {
				...
				mysql_query("insert into vyvod ( login, amount, karta, iin, phone, post_time ) values ( '".$row['login']."', ".$amount.", '".$nomer."', '".$iin."', '".$phone."', '".date('Y-m-d H:i:s')."')");
                                    ...
                                    <div class="card-body">
                                        <form action="withdraw.php" method="post">
                                            <div class="form-group" style="text-align: center">
                                                ...
                                                <input name="amount" type="number" class="form-control" min="100" placeholder="Введите сумму (мин. 100)" onkeypress="return isNumberKey(event)">
                                            </div>
											<div class="form-group" style="text-align: center">
                                                <label for="cc-payment" class="control-label mb-1">ИИН</label>
                                                <input name="iin" type="text" class="form-control" placeholder="Введите свой ИИН" onkeypress="return isNumberKey(event)">
                                            </div>
											<div class="form-group" style="text-align: center">
                                                ...
                                                <div class="form-group has-success" style="text-align: center">
                                                    ...
                                                    <input name="nomer" type="text" class="form-control" placeholder="Введите номер карты" onkeypress="return isNumberKey(event)">
