<?php
    ...
    $result = mysql_query("select login from users where login='".$login."' and pass='".$password."'");
    echo mysql_error();
...
<head>
    ...
    <meta name="author" content="gsmatrix.kz">
                    ...
                    <form action="login.php" method="post">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="submit" class="btn btn-info btn-flat m-b-30 m-t-30" value="Войти" name="sub_log">
