...
if (mysql_num_rows($result) != 0) {
	...
	mysql_query("update users set akwa=akwa-0, status=8, isStatusPaid=1 where login='".$row['login']."'");
} else {
	mysql_query("update users set balans_turbo=balans_turbo-0, status=8, isStatusPaid=1 where login='".$row['login']."'");
}
        ...
        <div class="content mt-3">
            <div class="card">
				...
				<div class="col-lg-12" style="text-align: center">
					...
					<span class="badge badge-success mt-2">DIAMOND Level 7</span>
